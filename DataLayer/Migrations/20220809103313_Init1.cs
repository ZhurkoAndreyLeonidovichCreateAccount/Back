        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationConcert = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AmountOfTickets = table.Column<int>(type: "int", nullable: false),
                    Image = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConcertsData", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Сlassic", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Сlassic_ConcertsData_Id",
                        column: x => x.Id,
                        principalTable: "ConcertsData",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<int>(type: "int", nullable: false),
                    HowToGet = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OpenAir_ConcertsData_Id",
                        column: x => x.Id,
                        principalTable: "ConcertsData",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Tickets_ConcertsData_ConcertId",
